...
public class Customer {
    ...
    public void setVilla(String idService, String nameService, double areaUser, double rentalCosts, int maxPeople, String typeRent) {
        this.service = new Villa();
        this.service.setId(idService);
        this.service.setNameService(nameService);
        this.service.setArea​​Use(areaUser);
